$(document).ready(function () {
  ...
  var typed = new Typed(".typing", {
    strings: ["Guru", "Politikus PDIP", "Ketua DPD Ikatan Sarjana Katolik-Kalbar", "Sekretaris Internal Dewan Adat Dayak Prov.Kalbar", "Secretary General Borneo Dayak Forum"],
    typeSpeed: 100,
    backSpeed: 60,
    loop: true,
  });
